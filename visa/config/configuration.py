...
from visa.utils.utils import read_ymal_file # helper function
import os 
import sys
...
class Configuration:
    def __init__(self,
                 ...
                 current_time_stamp:str = CURRECT_TIME_STAMP,)-> None:
        try:
            self.config_info = read_ymal_file(file_path = config_file_path)
